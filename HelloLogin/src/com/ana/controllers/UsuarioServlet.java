...
public class UsuarioServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// Si existe el dato usuario en sesión --> lo dejo pasar
		// Si no lo redirijo a login

		if (session.getAttribute("usuario") != null) {
			// si el atributo usuario existe dentro de sensión (es diferente a null)
			
			String idUsuario = request.getParameter("id");
			System.out.println("ID recibido: " + idUsuario);

			int idU = Integer.parseInt(idUsuario); // se pasa de string a número entero
